...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxd123cf30ed2b02c0',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'fca899eaeffa70035f4bcebb3710034a',
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'KSfmXFdXHWMsJ-c9Zj4Ef8ZrZaogcWyH9A66RE7P_HY',
      // 所在省份
      province: '广西',
      // 所在城市
      city: '崇左',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '宝贝', year: '2002', date: '07-30',
        },
        {
          type: '节日', name: '恋爱纪念日', year: '2021', date: '01-01',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '小吴', year: '2001', date: '07-18',
        },
        {
          type: '节日', name: '被搭讪纪念日', year: '2021', date: '12-14',
        }
      ],
      ...
      customizedDateList: [
        ...
        // 被搭讪纪念日
        { keyword: 'marry_day', date: '2020-12-14' },
        // 退伍日
